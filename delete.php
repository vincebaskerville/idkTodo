...
// they have just tried logging in
  ...
  $listname = $_SESSION['valid_list'];
  $conn = db_connect();
  
  $delete = $conn->query("DELETE FROM todo_lists
						  WHERE user_id = '".$username."'
						  AND list_name = '".$listname."'");
					  
  $delete2 = $conn->query("DELETE FROM todo_tasks
						  WHERE user_id = '".$username."'
						  AND list_name = '".$listname."'");
...
<html lang="en">
  <head>
	...
	<META http-equiv="refresh" content="0;URL=http://idktodo.com/member.php">
...
<div class="Content span-16 last"  id="form-right">
        	...
        	<div id="home" selected="true">  
							...
							<em>Your idk.List&trade; has been deleted!</em>
